...
@Component({
  selector: 'app-lead-preview-enquiry-list-section',
  templateUrl: './lead-preview-enquiry-list-section.component.html',
  styleUrls: ['./lead-preview-enquiry-list-section.component.scss']
})
export class LeadPreviewEnquiryListSectionComponent implements OnInit {

  @ViewChild(DatatableComponent) table: DatatableComponent;
  private _unsubscribeAll: Subject<any>;
  public _LeadId: number;
  @Input() set LeadId(data: number) {
    this._LeadId = data;
    console.log('hello Customer companyId:', this._LeadId)
  }
...
public data: any[] = [];
  ...
  constructor(
    private _leadEnquiryListService: LeadPreviewEnquiryListSectionService,
  ...
  ngOnInit(): void {
    ...
    // this.loadCustomer(this._LeadId);
    // this.fetchdata(this._LeadId);
  ...
  loadTransaction() {
    this.loading = true;
    this._leadEnquiryListService.getenquiryListByLeadId(this._LeadId,this.pageNumber, this.pageSize,"").subscribe(response => {
  ...
  filterUpdate(event: any) {
    ...
    this._leadEnquiryListService.getenquiryListByLeadId(this._LeadId,this.pageNumber, this.pageSize, val).subscribe(
      (response: any) => {
